export interface TypingVelocityMetrics {
  ...
  // Time from focus to the first value change; deliberate autofill/typing takes time/human delay, scripted fills tend to be near-instant.
  ...
  // Whether the field was populated without any preceding keystroke (paste, autofill, or programmatic fill; focus then change rather than focus, input, change).
